...
/**
 * @param {{ repo: string, files: any[], headSha: string, outDir: string, token: string, getContent?: typeof getFileContentAtRef }} input
 * @returns {Promise<{ headFilesDir: string, written: string[], omitted: string[] }>}
 */
export async function writeHeadFiles({ repo, files, headSha, outDir, token, getContent = getFileContentAtRef }) {
